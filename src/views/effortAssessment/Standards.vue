  ...
  try {
    ...
    if (response.data.isOk) {
      const project = response.data.project;
           console.log(project)
      // 动态更新信息卡片的数据
      infoCards[0].value = project.unadjustedFunctionPoints || 0; // 调整前规模
      ...
      // 动态更新表格数据
      tableData.value = [
        { category: 'EO', amount: project.eo || 0 },
        { category: 'EI', amount: project.ei || 0 },
        { category: 'EQ', amount: project.eq || 0 },
        { category: 'ILF', amount: project.ilf || 0 },
        { category: 'EIF', amount: project.eif || 0 },
      ];
